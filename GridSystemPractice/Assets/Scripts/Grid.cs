...
public class Grid
{
    ...
    public Grid(int width, int height, float cellSize, Vector3 originalPosition) 
    {
        ...
        for (int x = 0; x < gridArray.GetLength(0); x++)
        {
            ...
            {
                debugTextArray[x, y] = GridWorldTextUtils.CreateWorldText(gridArray[x, y].ToString(), null, GetWorldPosition(x, y) + new Vector3(cellSize, cellSize) * 0.5f, 20, Color.white, TextAnchor.MiddleCenter);
